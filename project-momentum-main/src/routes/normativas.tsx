...
function NormativasPage() {
  return (
    <div className="flex flex-col">
      {/* Hero */}
      <section className="bg-gradient-to-br from-[#1e3a8a] via-[#1e40af] to-[#3b82f6] py-16 md:py-20">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card className="border-blue-100">
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold text-[#1e3a8a] mb-2">Planes y tarifas</h3>
                <p className="text-sm text-muted-foreground mb-3">Consulta los planes disponibles, características y tarifas vigentes.</p>
                <Button asChild variant="outline" size="sm"><a href="/planes">Ver planes</a></Button>
              </CardContent>
            </Card>
            <Card className="border-blue-100">
              <CardContent className="p-6">
                <FileCheck className="h-8 w-8 text-[#1e3a8a] mb-3" />
                <h3 className="font-semibold text-[#1e3a8a] mb-2">Contrato de adhesión</h3>
                <p className="text-sm text-muted-foreground mb-3">Modelo del contrato de adhesión aprobado por ARCOTEL. Solicítalo en nuestras oficinas o por correo.</p>
            ...
            <Card className="border-blue-100">
              <CardContent className="p-6">
                <BookOpen className="h-8 w-8 text-[#1e3a8a] mb-3" />
                <h3 className="font-semibold text-[#1e3a8a] mb-2">Términos y condiciones generales</h3>
                <p className="text-sm text-muted-foreground">Aplicables al servicio de acceso a Internet, incluyen condiciones de instalación, facturación, suspensión, terminación y soporte técnico.</p>
              </CardContent>
            </Card>
            <Card className="border-blue-100">
              <CardContent className="p-6">
                <Users className="h-8 w-8 text-[#1e3a8a] mb-3" />
                <h3 className="font-semibold text-[#1e3a8a] mb-2">Derechos de los usuarios</h3>
                <p className="text-sm text-muted-foreground">Derecho a recibir el servicio en las condiciones contratadas, a la calidad pactada, a la facturación correcta, a presentar reclamos y a la protección de sus datos personales.</p>
              </CardContent>
            </Card>
      ...
      <section className="py-16 md:py-20 bg-secondary">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {documentos.map(doc => (
              <Card key={doc.file} className="border-blue-100 hover:shadow-md transition-shadow">
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            {hipervinculos.map(({ label, url, icon: Icon, desc }) => (
              <a
                key={url}
                href={url}
                target="_blank"
...
export const Route = createFileRoute("/normativas")({
  component: NormativasPage,
  head: () => ({
    meta: [
      { title: "Normativas y Transparencia — TELECOMNET S.A." },
      { name: "description", content: "Información técnica, regulatoria, derechos del usuario, política de privacidad y normativa vigente conforme a ARCOTEL." },
    ],
  }),
});
