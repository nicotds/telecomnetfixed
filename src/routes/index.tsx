          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <Reveal className="flex flex-col gap-6">
              ...
              <Button asChild className="w-fit bg-[#1e3a8a] hover:bg-[#1e40af] shadow-sm">
                <Link to="/planes">Conoce nuestros planes</Link>
              </Button>
            </Reveal>
...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Internet de fibra óptica con WiFi 6. Planes desde 350 MBPS hasta 800 MBPS. Instalación gratis, Router Dual Band y Soporte 24/7." },
    ],
  }),
});
